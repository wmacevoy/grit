...
CENTAUR_LIBS=-L../../libs/lib -ldxl -lfreenect -lfreenect_sync -lzmq -lSDL -lpthread -lboost_thread -Wl,--no-as-needed -ldl -lrt `../../libs/hokuyo/urg-0.8.18/c_urg-config --libs` -lm
