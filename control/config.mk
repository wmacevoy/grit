...
CONTROL_LIBS=-L../../libs/lib -L$(LEAP_LIB) -ldxl -lzmq -lSDL -lpthread -lboost_thread-mt -lboost_date_time-mt -Wl,--no-as-needed -lLeap -ldl -lrt `../../libs/bin/c_urg-config --libs` -lm
