...
tmp339=tmp3+(-0.78539816f);
tmp340=cos(tmp339);
tmp341=tmp6+(-0.78539816f);
tmp342=sin(tmp341);
tmp343=tmp95+0.087266463f;
tmp344=sin(tmp343);
...
tmp407=tmp3+(-0.78539816f);
tmp408=cos(tmp407);
tmp409=cos(tmp22);
tmp410=tmp6+(-0.78539816f);
tmp411=sin(tmp410);
tmp412=0.017453293f*tmp408*tmp409*tmp411;
...
tmp467=tmp0+(-0.78539816f);
tmp468=cos(tmp467);
tmp469=tmp398+0.6981317f;
tmp470=cos(tmp469);
tmp471=tmp3+(-0.78539816f);
tmp472=sin(tmp471);
tmp473=tmp6+(-0.78539816f);
tmp474=sin(tmp473);
tmp475=sin(tmp22);
tmp476=(-0.017453293f)*tmp472*tmp474*tmp475;
...
tmp514=tmp0+(-0.78539816f);
tmp515=cos(tmp514);
tmp516=tmp6+(-0.78539816f);
tmp517=cos(tmp516);
tmp518=tmp3+(-0.78539816f);
tmp519=sin(tmp518);
...
tmp531=cos(tmp22);
tmp532=tmp3+(-0.78539816f);
tmp533=sin(tmp532);
tmp534=tmp6+(-0.78539816f);
tmp535=sin(tmp534);
tmp536=tmp531*tmp533*tmp535;
tmp537=tmp530+tmp536;
tmp538=tmp526*tmp537;
tmp539=tmp6+(-0.78539816f);
tmp540=cos(tmp539);
tmp541=tmp0+(-0.78539816f);
tmp542=sin(tmp541);
tmp543=tmp3+(-0.78539816f);
tmp544=sin(tmp543);
tmp545=tmp540*tmp542*tmp544;
tmp546=tmp538+tmp545;
tmp547=(-0.017453293f)*tmp524*tmp546;
tmp548=tmp398+0.6981317f;
tmp549=cos(tmp548);
tmp550=tmp3+(-0.78539816f);
tmp551=cos(tmp550);
tmp552=cos(tmp22);
tmp553=tmp551*tmp552;
tmp554=tmp3+(-0.78539816f);
tmp555=sin(tmp554);
tmp556=tmp6+(-0.78539816f);
tmp557=sin(tmp556);
tmp558=sin(tmp22);
tmp559=(-1.0f)*tmp555*tmp557*tmp558;
tmp560=tmp553+tmp559;
tmp561=0.017453293f*tmp549*tmp560;
tmp562=tmp547+tmp561;
...
tmp569=tmp3+(-0.78539816f);
tmp570=cos(tmp569);
tmp571=cos(tmp22);
tmp572=tmp6+(-0.78539816f);
tmp573=sin(tmp572);
tmp574=0.017453293f*tmp570*tmp571*tmp573;
...
tmp585=tmp0+(-0.78539816f);
tmp586=cos(tmp585);
tmp587=tmp3+(-0.78539816f);
tmp588=sin(tmp587);
...
tmp606=sin(tmp605);
tmp607=sin(tmp22);
tmp608=(-0.017453293f)*tmp604*tmp606*tmp607;
tmp609=tmp3+(-0.78539816f);
tmp610=cos(tmp609);
tmp611=cos(tmp22);
tmp612=0.017453293f*tmp610*tmp611;
tmp613=tmp608+tmp612;
tmp614=tmp602*tmp613;
dresidual4_d_bicep=tmp614;
tmp615=tmp0+(-0.78539816f);
tmp616=cos(tmp615);
tmp617=tmp3+(-0.78539816f);
tmp618=cos(tmp617);
tmp619=sin(tmp22);
tmp620=tmp618*tmp619;
tmp621=cos(tmp22);
tmp622=tmp3+(-0.78539816f);
tmp623=sin(tmp622);
