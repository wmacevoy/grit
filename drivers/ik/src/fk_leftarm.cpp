...
ans(0,3)=tmp136;
tmp137=tmp0+(-0.6981317f);
tmp138=cos(tmp137);
tmp139=(-0.017453293f)*waist;
tmp140=cos(tmp139);
tmp141=cos(tmp6);
tmp142=tmp3+0.78539816f;
tmp143=sin(tmp142);
tmp144=tmp140*tmp141*tmp143;
tmp145=sin(tmp6);
...
tmp166=sin(tmp165);
tmp167=sin(tmp6);
tmp168=tmp164*tmp166*tmp167;
tmp169=cos(tmp6);
tmp170=tmp3+0.78539816f;
tmp171=cos(tmp170);
tmp172=cos(tmp139);
tmp173=tmp11+(-0.78539816f);
tmp174=sin(tmp173);
tmp175=(-1.0f)*tmp171*tmp172*tmp174;
tmp176=tmp11+(-0.78539816f);
tmp177=cos(tmp176);
tmp178=sin(tmp139);
...
tmp219=sin(tmp218);
tmp220=sin(tmp6);
tmp221=tmp217*tmp219*tmp220;
tmp222=cos(tmp6);
tmp223=tmp3+0.78539816f;
tmp224=cos(tmp223);
tmp225=cos(tmp139);
tmp226=tmp11+(-0.78539816f);
tmp227=sin(tmp226);
tmp228=(-1.0f)*tmp224*tmp225*tmp227;
tmp229=tmp11+(-0.78539816f);
tmp230=cos(tmp229);
tmp231=sin(tmp139);
tmp232=(-1.0f)*tmp230*tmp231;
tmp233=tmp228+tmp232;
tmp234=tmp222*tmp233;
tmp235=tmp221+tmp234;
tmp236=tmp216*tmp235;
tmp237=tmp214+tmp236;
ans(1,1)=tmp237;
tmp238=tmp0+(-0.6981317f);
tmp239=cos(tmp238);
...
tmp244=sin(tmp243);
tmp245=sin(tmp6);
tmp246=tmp242*tmp244*tmp245;
tmp247=cos(tmp6);
tmp248=tmp3+0.78539816f;
tmp249=cos(tmp248);
tmp250=cos(tmp139);
tmp251=tmp11+(-0.78539816f);
tmp252=sin(tmp251);
tmp253=(-1.0f)*tmp249*tmp250*tmp252;
tmp254=tmp11+(-0.78539816f);
tmp255=cos(tmp254);
tmp256=sin(tmp139);
tmp257=(-1.0f)*tmp255*tmp256;
tmp258=tmp253+tmp257;
tmp259=tmp247*tmp258;
tmp260=tmp246+tmp259;
...
tmp316=cos(tmp315);
tmp317=cos(tmp139);
tmp318=9.0f*tmp314*tmp316*tmp317;
...
tmp337=sin(tmp336);
tmp338=sin(tmp6);
tmp339=tmp335*tmp337*tmp338;
tmp340=cos(tmp6);
tmp341=tmp3+0.78539816f;
tmp342=cos(tmp341);
tmp343=cos(tmp139);
tmp344=tmp11+(-0.78539816f);
tmp345=sin(tmp344);
tmp346=(-1.0f)*tmp342*tmp343*tmp345;
tmp347=tmp11+(-0.78539816f);
tmp348=cos(tmp347);
tmp349=sin(tmp139);
tmp350=(-1.0f)*tmp348*tmp349;
tmp351=tmp346+tmp350;
tmp352=tmp340*tmp351;
tmp353=tmp339+tmp352;
tmp354=14.0f*tmp334*tmp353;
tmp355=tmp302+tmp306+tmp308+tmp312+tmp318+tmp332+tmp354;
ans(1,3)=tmp355;
tmp356=tmp0+(-0.6981317f);
tmp357=cos(tmp356);
tmp358=cos(tmp6);
...
tmp528=cos(tmp527);
tmp529=sin(tmp139);
tmp530=9.0f*tmp526*tmp528*tmp529;
tmp531=cos(tmp139);
tmp532=tmp11+(-0.78539816f);
tmp533=sin(tmp532);
tmp534=9.0f*tmp531*tmp533;
tmp535=cos(tmp139);
tmp536=13.5f*tmp535;
tmp537=tmp20+0.78539816f;
tmp538=cos(tmp537);
tmp539=tmp3+0.78539816f;
tmp540=cos(tmp539);
tmp541=tmp11+(-0.78539816f);
tmp542=cos(tmp541);
tmp543=sin(tmp139);
tmp544=tmp540*tmp542*tmp543;
tmp545=cos(tmp139);
tmp546=tmp11+(-0.78539816f);
tmp547=sin(tmp546);
tmp548=tmp545*tmp547;
tmp549=tmp544+tmp548;
tmp550=14.0f*tmp538*tmp549;
...
tmp573=tmp520+tmp524+tmp530+tmp534+tmp536+tmp550+tmp572+12.0f;
ans(2,3)=tmp573;
  return ans;
}