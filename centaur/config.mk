...
CENTAUR_LIBS=-L../../libs/lib -ldxl -lzmq -lSDL -lSDL_net -lpthread -lboost_thread -lboost_filesystem -lboost_system -Wl,--no-as-needed -ldl -lrt `../../libs/hokuyo/urg-0.8.18/c_urg-config --libs` -lm
