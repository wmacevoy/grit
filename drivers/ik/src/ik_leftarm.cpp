...
tmp209=cos(tmp208);
tmp210=tmp6+0.78539816f;
tmp211=sin(tmp210);
tmp212=tmp0+(-0.78539816f);
tmp213=sin(tmp212);
...
tmp182=cos(tmp181);
tmp183=tmp91+0.087266463f;
tmp184=cos(tmp183);
tmp185=tmp6+(-0.78539816f);
tmp186=sin(tmp185);
tmp187=(-1.0f)*tmp182*tmp184*tmp186;
tmp188=tmp6+(-0.78539816f);
tmp189=cos(tmp188);
tmp190=tmp91+0.087266463f;
tmp191=sin(tmp190);
tmp192=(-1.0f)*tmp189*tmp191;
tmp193=tmp187+tmp192;
tmp194=(-0.017453293f)*tmp180*tmp193;
tmp195=tmp91+0.087266463f;
tmp196=cos(tmp195);
tmp197=cos(tmp22);
tmp198=tmp0+0.78539816f;
tmp199=sin(tmp198);
tmp200=0.017453293f*tmp196*tmp197*tmp199;
...
tmp332=sin(tmp331);
tmp333=sin(tmp22);
tmp334=tmp6+(-0.78539816f);
tmp335=cos(tmp334);
tmp336=tmp91+0.087266463f;
tmp337=cos(tmp336);
tmp338=tmp335*tmp337;
tmp339=tmp0+0.78539816f;
tmp340=cos(tmp339);
tmp341=tmp6+(-0.78539816f);
tmp342=sin(tmp341);
tmp343=tmp91+0.087266463f;
tmp344=sin(tmp343);
tmp345=(-1.0f)*tmp340*tmp342*tmp344;
tmp346=tmp338+tmp345;
tmp347=(-0.017453293f)*tmp333*tmp346;
tmp348=cos(tmp22);
tmp349=tmp0+0.78539816f;
tmp350=sin(tmp349);
tmp351=tmp91+0.087266463f;
tmp352=sin(tmp351);
tmp353=0.017453293f*tmp348*tmp350*tmp352;
...
tmp401=cos(tmp400);
tmp402=cos(tmp22);
tmp403=tmp6+(-0.78539816f);
tmp404=sin(tmp403);
tmp405=(-0.017453293f)*tmp401*tmp402*tmp404;
...
tmp431=sin(tmp430);
tmp432=tmp12+(-0.78539816f);
tmp433=sin(tmp432);
tmp434=0.017453293f*tmp428*tmp429*tmp431*tmp433;
tmp435=tmp426+tmp434;
dresidual3_d_shoulderud=tmp435;
tmp436=tmp12+(-0.78539816f);
tmp437=sin(tmp436);
tmp438=tmp0+0.78539816f;
tmp439=sin(tmp438);
tmp440=tmp6+(-0.78539816f);
tmp441=sin(tmp440);
tmp442=sin(tmp22);
tmp443=(-0.017453293f)*tmp439*tmp441*tmp442;
tmp444=tmp0+0.78539816f;
tmp445=cos(tmp444);
tmp446=cos(tmp22);
tmp447=0.017453293f*tmp445*tmp446;
...
tmp474=cos(tmp473);
tmp475=tmp12+(-0.78539816f);
tmp476=cos(tmp475);
tmp477=tmp0+0.78539816f;
tmp478=cos(tmp477);
tmp479=cos(tmp22);
tmp480=tmp6+(-0.78539816f);
tmp481=sin(tmp480);
tmp482=(-0.017453293f)*tmp478*tmp479*tmp481;
tmp483=tmp0+0.78539816f;
tmp484=sin(tmp483);
tmp485=sin(tmp22);
tmp486=0.017453293f*tmp484*tmp485;
...
tmp533=cos(tmp532);
tmp534=tmp0+0.78539816f;
tmp535=sin(tmp534);
tmp536=tmp472+(-0.6981317f);
tmp537=sin(tmp536);
tmp538=sin(tmp22);
...
tmp542=cos(tmp541);
tmp543=tmp472+(-0.6981317f);
tmp544=cos(tmp543);
tmp545=tmp0+0.78539816f;
tmp546=sin(tmp545);
tmp547=tmp6+(-0.78539816f);
tmp548=sin(tmp547);
tmp549=sin(tmp22);
tmp550=(-0.017453293f)*tmp546*tmp548*tmp549;
tmp551=tmp0+0.78539816f;
tmp552=cos(tmp551);
tmp553=cos(tmp22);
tmp554=0.017453293f*tmp552*tmp553;
tmp555=tmp550+tmp554;
tmp556=tmp542*tmp544*tmp555;
tmp557=tmp472+(-0.6981317f);
tmp558=sin(tmp557);
tmp559=tmp0+0.78539816f;
tmp560=cos(tmp559);
tmp561=sin(tmp22);
tmp562=(-0.017453293f)*tmp560*tmp561;
tmp563=cos(tmp22);
tmp564=tmp0+0.78539816f;
tmp565=sin(tmp564);
...
tmp573=cos(tmp572);
tmp574=tmp12+(-0.78539816f);
tmp575=sin(tmp574);
tmp576=tmp0+0.78539816f;
tmp577=cos(tmp576);
tmp578=sin(tmp22);
tmp579=tmp577*tmp578;
tmp580=cos(tmp22);
tmp581=tmp0+0.78539816f;
tmp582=sin(tmp581);
...
tmp588=tmp12+(-0.78539816f);
tmp589=cos(tmp588);
tmp590=tmp6+(-0.78539816f);
tmp591=cos(tmp590);
tmp592=tmp0+0.78539816f;
tmp593=sin(tmp592);
...
tmp598=sin(tmp597);
tmp599=tmp12+(-0.78539816f);
tmp600=cos(tmp599);
tmp601=tmp0+0.78539816f;
tmp602=cos(tmp601);
tmp603=sin(tmp22);
tmp604=tmp602*tmp603;
tmp605=cos(tmp22);
tmp606=tmp0+0.78539816f;
tmp607=sin(tmp606);
tmp608=tmp6+(-0.78539816f);
tmp609=sin(tmp608);
tmp610=tmp605*tmp607*tmp609;
tmp611=tmp604+tmp610;
tmp612=tmp600*tmp611;
tmp613=tmp6+(-0.78539816f);
tmp614=cos(tmp613);
tmp615=tmp0+0.78539816f;
tmp616=sin(tmp615);
tmp617=tmp12+(-0.78539816f);
tmp618=sin(tmp617);
tmp619=tmp614*tmp616*tmp618;
tmp620=tmp612+tmp619;
tmp621=(-0.017453293f)*tmp598*tmp620;
tmp622=tmp472+(-0.6981317f);
tmp623=cos(tmp622);
tmp624=tmp0+0.78539816f;
tmp625=cos(tmp624);
tmp626=cos(tmp22);
tmp627=tmp625*tmp626;
tmp628=tmp0+0.78539816f;
tmp629=sin(tmp628);
tmp630=tmp6+(-0.78539816f);
tmp631=sin(tmp630);
tmp632=sin(tmp22);
tmp633=(-1.0f)*tmp629*tmp631*tmp632;
tmp634=tmp627+tmp633;
tmp635=0.017453293f*tmp623*tmp634;
tmp636=tmp621+tmp635;
