...
CONTROL_FLAGS=-Iinclude -I../../libs/include -I../../setup `../../libs/bin/c_urg-config --cflags`
CONTROL_LIBS=-L../../libs/lib -ldxl -lzmq -lSDL -lpthread -lboost_thread-mt -lboost_date_time-mt -ljson -Wl,--no-as-needed -lLeap -ldl -lrt `../../libs/bin/c_urg-config --libs` -lm
