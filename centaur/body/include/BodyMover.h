...
class BodyMover
{
 public:
  ...
  BodyMover();
  std::vector<std::vector<double> > bMove(double radius,double x,double y,double z,double step,double direction,double zStep,int repeat=1,float rotation=0.0);
  ...
  bool bStep(double radius,double x,double y,double z,double step,double directionDegrees,double zStep,int repeat=1,bool rotation=false);
