...
tmp23=cos(tmp2);
tmp24=sin(tmp12);
tmp25=(-1.0f)*tmp23*tmp24;
tmp26=cos(tmp12);
tmp27=sin(tmp2);
tmp28=(-1.0f)*tmp26*ans(0,0)*tmp27;
tmp29=tmp25+tmp28;
ans(1,2)=tmp29;
tmp30=sin(tmp12);
tmp31=(-13.5f)*tmp30;
...
tmp36=cos(tmp2);
tmp37=sin(tmp12);
tmp38=(-1.375f)*tmp36*tmp37;
tmp39=cos(tmp12);
tmp40=sin(tmp2);
tmp41=(-1.375f)*tmp39*ans(0,0)*tmp40;
