...
tmp125=cos(tmp124);
tmp126=tmp11+0.78539816f;
tmp127=cos(tmp126);
tmp128=tmp1+(-0.78539816f);
tmp129=cos(tmp128);
tmp130=cos(tmp23);
tmp131=tmp5+(-0.78539816f);
tmp132=sin(tmp131);
tmp133=(-1.0f)*tmp129*tmp130*tmp132;
tmp134=tmp1+(-0.78539816f);
tmp135=sin(tmp134);
tmp136=sin(tmp23);
tmp137=(-1.0f)*tmp135*tmp136;
tmp138=tmp133+tmp137;
tmp139=tmp127*tmp138;
tmp140=tmp1+(-0.78539816f);
tmp141=cos(tmp140);
tmp142=tmp5+(-0.78539816f);
tmp143=cos(tmp142);
tmp144=tmp11+0.78539816f;
tmp145=sin(tmp144);
tmp146=(-1.0f)*tmp141*tmp143*tmp145;
tmp147=tmp139+tmp146;
tmp148=tmp125*tmp147;
tmp149=tmp82+0.52359878f;
tmp150=sin(tmp149);
tmp151=tmp1+(-0.78539816f);
tmp152=cos(tmp151);
tmp153=tmp5+(-0.78539816f);
tmp154=sin(tmp153);
tmp155=sin(tmp23);
tmp156=tmp152*tmp154*tmp155;
tmp157=cos(tmp23);
tmp158=tmp1+(-0.78539816f);
tmp159=sin(tmp158);
...
tmp384=cos(tmp22);
tmp385=tmp0+(-0.78539816f);
tmp386=sin(tmp385);
tmp387=tmp6+(-0.78539816f);
tmp388=sin(tmp387);
tmp389=0.017453293f*tmp384*tmp386*tmp388;
tmp390=tmp383+tmp389;
tmp391=tmp379*tmp390;
tmp392=tmp6+(-0.78539816f);
tmp393=cos(tmp392);
tmp394=tmp10+0.78539816f;
tmp395=sin(tmp394);
tmp396=tmp0+(-0.78539816f);
tmp397=sin(tmp396);
...
tmp407=tmp0+(-0.78539816f);
tmp408=sin(tmp407);
tmp409=tmp6+(-0.78539816f);
tmp410=sin(tmp409);
tmp411=sin(tmp22);
...
dresidual4_dRIGHTARM_SHOULDER_IO_=tmp415;
tmp416=tmp211+0.52359878f;
tmp417=cos(tmp416);
tmp418=tmp10+0.78539816f;
tmp419=cos(tmp418);
...
dresidual4_dRIGHTARM_SHOULDER_UD_=tmp443;
tmp444=tmp10+0.78539816f;
tmp445=cos(tmp444);
tmp446=tmp211+0.52359878f;
tmp447=cos(tmp446);
tmp448=cos(tmp22);
tmp449=tmp0+(-0.78539816f);
tmp450=sin(tmp449);
tmp451=(-0.017453293f)*tmp448*tmp450;
tmp452=tmp0+(-0.78539816f);
tmp453=cos(tmp452);
tmp454=tmp6+(-0.78539816f);
tmp455=sin(tmp454);
tmp456=sin(tmp22);
tmp457=0.017453293f*tmp453*tmp455*tmp456;
tmp458=tmp451+tmp457;
...
tmp463=cos(tmp462);
tmp464=cos(tmp22);
tmp465=tmp6+(-0.78539816f);
tmp466=sin(tmp465);
tmp467=0.017453293f*tmp463*tmp464*tmp466;
tmp468=tmp0+(-0.78539816f);
tmp469=sin(tmp468);
tmp470=sin(tmp22);
...
dresidual4_dRIGHTARM_BICEP_ROTATE_=tmp474;
...
tmp485=sin(tmp484);
tmp486=tmp0+(-0.78539816f);
tmp487=cos(tmp486);
tmp488=cos(tmp22);
tmp489=tmp6+(-0.78539816f);
tmp490=sin(tmp489);
tmp491=(-1.0f)*tmp487*tmp488*tmp490;
tmp492=tmp0+(-0.78539816f);
tmp493=sin(tmp492);
tmp494=sin(tmp22);
tmp495=(-1.0f)*tmp493*tmp494;
tmp496=tmp491+tmp495;
tmp497=0.017453293f*tmp485*tmp496;
tmp498=tmp483+tmp497;
tmp499=tmp476*tmp498;
dresidual4_dRIGHTARM_ELBOW_=tmp499;
tmp500=tmp211+0.52359878f;
tmp501=sin(tmp500);
tmp502=tmp10+0.78539816f;
tmp503=cos(tmp502);
tmp504=tmp0+(-0.78539816f);
tmp505=cos(tmp504);
tmp506=cos(tmp22);
tmp507=tmp6+(-0.78539816f);
tmp508=sin(tmp507);
tmp509=(-1.0f)*tmp505*tmp506*tmp508;
tmp510=tmp0+(-0.78539816f);
tmp511=sin(tmp510);
tmp512=sin(tmp22);
tmp513=(-1.0f)*tmp511*tmp512;
tmp514=tmp509+tmp513;
tmp515=tmp503*tmp514;
tmp516=tmp0+(-0.78539816f);
tmp517=cos(tmp516);
tmp518=tmp6+(-0.78539816f);
tmp519=cos(tmp518);
tmp520=tmp10+0.78539816f;
tmp521=sin(tmp520);
tmp522=(-1.0f)*tmp517*tmp519*tmp521;
tmp523=tmp515+tmp522;
tmp524=(-0.017453293f)*tmp501*tmp523;
tmp525=tmp211+0.52359878f;
tmp526=cos(tmp525);
tmp527=tmp0+(-0.78539816f);
tmp528=cos(tmp527);
tmp529=tmp6+(-0.78539816f);
tmp530=sin(tmp529);
tmp531=sin(tmp22);
tmp532=tmp528*tmp530*tmp531;
tmp533=cos(tmp22);
...
dresidual4_dRIGHTARM_FOREARM_ROTATE_=tmp539;
} // ik_rightarmdf()
